...
JNIEXPORT void JNICALL Java_org_codetwisted_widget_StackBlurAlgorithmProvider_functionToBlur(JNIEnv* env, jclass clzz, jobject bitmapOut, jint radius, jint threadCount, jint threadIndex, jint round) {
    // Properties
